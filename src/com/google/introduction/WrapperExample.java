...
public class WrapperExample {
    public static void main(String[] args) {
        ...
        // For objects, final means that the reference cannot be changed, but the object
        ...
        // garbage collected.
        // It is called by the garbage collector when it determines that there are no
        // more references to
        // the object. It is used to release resources or perform any necessary cleanup.
        // It is not guaranteed to be called immediately after the object is no longer
        // reachable.
        A obj = new A("example");
    ...
    static void swap(Integer x, Integer y) {
        // This will not swap the values because x and y are references to Integer
        // objects.
